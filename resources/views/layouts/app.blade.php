    ...
    <footer class="bg-gray-900 text-white py-16">
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="flex justify-center space-x-6">
                ...
                <a href="https://wa.me/6282280998904?text=Halo%20kak,%20saya%20ingin%20bertanya%20mengenai%20layanan."
                    target="_blank"
            ...
            <div class="mt-12 pt-8 border-t border-gray-700">
                <p class="text-gray-400">&copy; {{ date('Y') }} PT. Mitra Data Abadi. All rights reserved.</p>
                <p class="text-gray-500 mt-2 italic">Your Trusted IT Partner</p>
            </div>
        </div>
    </footer>
